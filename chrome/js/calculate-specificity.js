...
var calculateSpecificity = function(input) {
	var selectors,
		selector,
		i,
		len,
	...
	for (i = 0, len = selectors.length; i < len; i += 1) {
		...
		if (selector.length > 0) {
			results.push(calculateSingleSpecificity(selector));
		}
	}
 ...
 */
var calculateSingleSpecificity = function(input) {
	var selector = input,
		findMatch,
		typeCount = {
			'a': 0,
...
var compareSpecificity = function(a, b) {
	...
	if (typeof a ==='string') {
		if (a.indexOf(',') !== -1) {
			...
			aSpecificity = calculateSingleSpecificity(a)['specificityArray'];
		}
	...
	if (typeof b ==='string') {
		if (b.indexOf(',') !== -1) {
			...
			bSpecificity = calculateSingleSpecificity(b)['specificityArray'];
		}
